...
- Smol AI News: https://news.smol.ai/ (High density, excellent for rapid catch-up)
- arXiv AI: https://arxiv.org/list/cs.AI/recent (For technical/research depth)
- Hugging Face Daily Papers: https://huggingface.co/papers (Community-vetted research)
...
The news briefing is delivered through two main channels:

### 1. 🚀 Feishu Messaging (Real-time)
-   **Channel**: Direct message or Group chat via Feishu API.
-   **Format**: Interactive cards with category tabs or list view.
-   **Content**: Full summaries for key stories, headlines for minor ones, and direct links.

### 2. 📂 GitHub Repository (Archival)
-   **Branch**: `daily-news` or a dedicated date-based branch.
-   -   **Path**: `NEWS/daily/[YYYY-MM-DD].md`
-   **Content**: Full archival version of the briefing.
